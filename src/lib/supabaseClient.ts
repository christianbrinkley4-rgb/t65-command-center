...
// Same Supabase project used by v1 (T65 Daily Command Center).
// The anon key is safe to ship in a static bundle — Row Level Security
// on public.leads is what actually protects the data (authenticated-only
